...
{
    public class CreateBlogCommand(string title, string slug, string content, List<Guid> blogCategoryIds, Status status, string metaDescription, DateTimeOffset publishedAt, string? metaTitle = null, string? canonicalUrl = null, string? ogImage = null, string? coverImage = null) : IWebArMaCommand<Guid>
    {
